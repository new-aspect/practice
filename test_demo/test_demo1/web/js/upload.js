function DragImgUpload(id,options) {
    ...
    this.preview = $('<div id="preview"><div class="pretitle"></div></div>');
...
DragImgUpload.prototype = {
    ...
    onDrop:function (e) {
        ...
        self.me.find(".pretitle").attr("src",img);
        self.me.find(".pretitle").attr("title",filename);
        if(this.callback){
    ...
    onChangeUploadFile:function () {
        ...
        this.me.find(".pretitle").attr("src",img);
        this.me.find(".pretitle").attr("title",filename);
        if(this.callback){
            this.callback(files);
        }
    },
