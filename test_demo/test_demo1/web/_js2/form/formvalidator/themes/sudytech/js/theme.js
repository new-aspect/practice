...
//初始状态，加其它几种状态
var passwordStrengthStatusHtml = [
'<P id=passStrong class="pswState"><B class="progressImage prog0"></B><EM class=st3>请输入合法的密码</EM></P>',
'<P id=passStrong class="pswState"><B class="progressImage prog1"></B><EM class=st3>弱</EM></P>',
'<P id=passStrong class="pswState"><B class="progressImage prog2"></B><EM class=st2>中等</EM></P>',
'<P id=passStrong class="pswState"><B class="progressImage prog3"></B><EM class=st2>强</EM></P>'							  ];

//var passwordStrengthText = ['密码强度：弱','密码强度：中','密码强度：强']
var passwordStrengthText = ['<P id=passStrong class="pswState"><B class="progressImage prog1"></B><EM class=st3>弱</EM></P>','<P id=passStrong class="pswState"><B class="progressImage prog2"></B><EM class=st2>中等</EM></P>','<P id=passStrong class="pswState"><B class="progressImage prog3"></B><EM class=st2>强</EM></P>']
